...
// zion surgical: 官方此处用 `import type {} from '@deepseek-ai/dsh-client-ui-conversation/client'`
// 把 ui-conversation 的 SlotMap merge('conversation.composer' 条目)拉进编译面;
// zion 无该包别名,且 vendored ui-conversation contract/slots.ts 已在图内自带该
// merge(本文件与 ApprovalPanel 同图编译),故此行删除不改变类型面。
