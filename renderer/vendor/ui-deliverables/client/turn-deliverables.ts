 ...
 */
import type {
  ConversationLocationDataStore, ConversationNodeDefinition, ConversationTurnDataMap, ToolResultNode,
} from '@deepseek-ai/dsh-client-runtime/client'
import { isAppendSurfaceEvent } from '@deepseek-ai/dsh-client-runtime/client'
import type { MarkdownFileMentions } from '@deepseek-ai/dsh-client-ui-primitives'
// zion patch: 官方 TurnTailOwnerProps 来自 ui-conversation contract(不在编译面);
// 本地化为结构面(selectProducedFiles 只消费 seq + turn.data)。
interface TurnTailOwnerProps {
  readonly seq: number
  readonly turn: { readonly data: ConversationLocationDataStore<ConversationTurnDataMap> }
}
