...
// 这里本地化为 openFile 面(selectProducedFiles 的 owner 类型在 turn-deliverables 本地化)。
type TurnTailOpenFile = (path: string) => void
...
export type ProducedFilesProps = { openFile: TurnTailOpenFile } & {
