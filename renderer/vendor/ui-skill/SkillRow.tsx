...
// zion patch: 官方 ToolCallViewProps 来自 ui-tool contract(不在编译面);
// 本地化为 SkillRow 消费的 block/inspect 面。
import type { ToolCallBlock } from '@deepseek-ai/dsh-client-runtime/client'
interface ToolCallViewProps { block: ToolCallBlock; inspect?: (() => void) | undefined }
